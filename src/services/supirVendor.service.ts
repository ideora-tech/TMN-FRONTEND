...
export const supirVendorService = {
    ...
    async create(payload: { id_vendor: string; nama: string; telepon?: string | null; no_sim?: string | null; masa_berlaku_sim?: string | null; id_kontrak_vendor?: string | null; aktif?: boolean }) {
