...
export const protectedRoutes: Routes = {
    ...
    ...listRoute('dokumen-armada', 'dokumen-armada'),
    '/dokumen-armada/[id]/perpanjang': { key: 'dokumen-armada', authority: [], dynamicRoute: true },
    ...
    ...listRoute('permintaan-pembelian', 'permintaan-pembelian'),
    '/permintaan-pembelian/[id]/edit': { key: 'permintaan-pembelian', authority: [], dynamicRoute: true },
    '/master-barang': { key: 'master-barang', authority: [] },
    '/pengadaan': { key: 'pengadaan', authority: [] },
