...
const INIT: FormState = { nama_rute: '', id_lokasi_asal: '', id_lokasi_tujuan: '', estimasi_jarak_km: '', estimasi_durasi_menit: '', keterangan: '', aktif: true }
        ...
        <div className="flex flex-col gap-4">
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-0.5">Isi informasi rute perjalanan — kode rute dibuat otomatis</p>
                </div>
            </div>
            <Card>
                <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-1">
                        <FormItem label="Nama Rute" asterisk invalid={!!errors.nama_rute} errorMessage={errors.nama_rute} className="sm:col-span-2">
