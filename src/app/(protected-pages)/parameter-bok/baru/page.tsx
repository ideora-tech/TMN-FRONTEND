...
export default function ParameterBokBaruPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setSaving(true)
        try {
            await parameterBokService.create({
            ...
            toast.push(<Notification type="success" title="Parameter BOK berhasil ditambahkan" />)
    ...
    return (
        <div className="flex flex-col gap-4">
            <div className="flex items-center gap-3">
                ...
                <div>
                    <h4 className="font-bold">Tambah Parameter BOK</h4>
