...
interface DashboardStats {
    ...
    fakturDraft: number | null
    pendapatanBulanIni: number | null
    piutangBeredar: number | null
    alerts?: {
        dokumenExpiring: {
            total: number
...
export default function DashboardOperasionalTab() {
    ...
    const cards = [
        ...
        ...(stats.fakturDraft !== null ? [{ label: 'Invoice Draft', value: stats.fakturDraft, icon: <PiReceiptDuotone className="text-3xl text-amber-500" />, bg: 'bg-amber-50 dark:bg-amber-500/10', text: 'text-amber-600 dark:text-amber-400' }] : []),
        ...(stats.pendapatanBulanIni !== null ? [{ label: 'Pendapatan Bulan Ini', value: formatRupiah(stats.pendapatanBulanIni), icon: <PiCurrencyCircleDollarDuotone className="text-3xl text-green-500" />, bg: 'bg-green-50 dark:bg-green-500/10', text: 'text-green-600 dark:text-green-400', isRupiah: true }] : []),
        ...(stats.piutangBeredar !== null ? [{ label: 'Piutang Beredar', value: stats.piutangBeredar, icon: <PiClockCountdownDuotone className="text-3xl text-red-500" />, bg: 'bg-red-50 dark:bg-red-500/10', text: 'text-red-600 dark:text-red-400' }] : []),
    ]
