...
export default function DashboardOperasionalTab() {
    ...
    const cards = [
        ...
        ...(stats.fakturDraft !== null ? [{ label: 'Faktur Draft', value: stats.fakturDraft, icon: <PiReceiptDuotone className="text-3xl text-amber-500" />, bg: 'bg-amber-50 dark:bg-amber-500/10', text: 'text-amber-600 dark:text-amber-400' }] : []),
