...
const STATUS_AKTIF = 'belum_mulai,berjalan'
...
export default function TripAktifTab() {
    ...
    const statusEfektif = statusFilter || STATUS_AKTIF
    ...
    }, [currentPage, pageSize, search, statusEfektif])
            ...
            <Card bodyClass="p-0">
                ...
                {loading ? (
                    ...
                    <p className="text-gray-400 text-sm text-center py-8">
                        Tidak ada trip aktif saat ini — riwayat trip yang sudah selesai ada di tab Riwayat.
                    </p>
                ) : (
                        ...
                        <table className="w-full text-sm">
                            <thead className="bg-blue-50 dark:bg-blue-500/10">
                                <tr className="border-b border-gray-100 dark:border-gray-700">
                                    ...
                                    <th className="text-left py-2.5 px-3 text-xs font-semibold text-gray-500 dark:text-gray-100 uppercase tracking-wide">Trip Aktif</th>
                                    <th className="w-12" />
                                </tr>
                            </thead>
                                                ...
                                                <tr>
                                                    <td colSpan={5} className="p-0 bg-gray-50/60 dark:bg-gray-800/30">
                                                        {isLoadingTrips ? (
                                                            ...
                                                            <p className="text-gray-400 text-xs text-center py-4">Belum ada trip aktif untuk proyek ini.</p>
                                                        ) : (
