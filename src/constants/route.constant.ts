export const ROUTES = {
    ...
    DOKUMEN_ARMADA_BARU: '/dokumen-armada/baru',
    DOKUMEN_ARMADA_DETAIL: (id: string) => `/dokumen-armada/${id}`,
    DOKUMEN_ARMADA_PERPANJANG: (id: string) => `/dokumen-armada/${id}/perpanjang`,
    PERAWATAN_ARMADA_BARU:   '/perawatan-armada/baru',
    PERAWATAN_ARMADA_DETAIL: (id: string) => `/perawatan-armada/${id}`,
    JENIS_PERAWATAN:        '/perawatan-armada?tab=jenis',
    ...
    SPAREPART_TAB_KATEGORI: '/sparepart?tab=kategori',
    SPAREPART_TAB_PAKET:    '/sparepart?tab=paket',
    ...
    KETERSEDIAAN_VENDOR: '/ketersediaan-vendor',
